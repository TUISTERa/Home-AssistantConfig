$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock"] = new baseclock("default-clock", "", "frosty_flake", {'widget_type': 'baseclock', 'use_comma': 0, 'fields': {'date': '', 'time': ''}, 'css': {}, 'icons': [], 'static_icons': [], 'static_css': {'date_style': 'text-shadow: 1px 1px #939da5;color: #ED0090;', 'time_style': 'text-shadow: 1px 1px #1a1818;color: #ED0090;', 'widget_style': 'background-color: rgba(255,255,255,0.7);'}, 'time_format': '24hr', 'precision': 1})
    
        widgets["default-temp"] = new basedisplay("default-temp", "", "frosty_flake", {'css': {'value_style': '', 'unit_style': '', 'text_style': 'text-shadow: 2px 2px #5f5555;color: #fff;'}, 'fields': {'title': 'Температура', 'value': '', 'state_text': '', 'unit': '', 'title2': ''}, 'use_comma': 0, 'widget_type': 'basedisplay', 'sub_entity': '', 'icons': [], 'static_icons': [], 'precision': 1, 'entity': 'sensor.tank_temp', 'static_css': {'title2_style': 'text-shadow: 1px 1px #5f5555;font-weight: 400;color: #fff;', 'state_text_style': '', 'value_style': '', 'unit_style': '', 'widget_style': 'background-color: rgba(255,255,255,0.7);', 'title_style': 'text-shadow: 1px 1px #5f5555;font-weight: 400;color: #fff;'}})
    
        widgets["default-light"] = new baseswitch("default-light", "", "frosty_flake", {'fields': {'title': 'Осветление', 'state_text': '', 'icon_style': '', 'icon': '', 'title2': ''}, 'state_inactive': 'off', 'post_service_active': {'entity_id': 'light.bedroom_2', 'service': 'homeassistant/turn_on'}, 'enable': 1, 'precision': 1, 'icon_on': 'mdi-lightbulb-on', 'static_css': {'title2_style': 'text-shadow: 1px 1px #5f5555;font-weight: 400;color: #fff;', 'state_text_style': 'text-shadow: 2px 2px #5f5555;color: #fff;', 'title_style': 'text-shadow: 1px 1px #5f5555;font-weight: 400;color: #fff;', 'widget_style': 'background-color: rgba(255,255,255,0.7);'}, 'widget_type': 'baseswitch', 'use_comma': 0, 'entity': 'light.bedroom_2', 'css': {'icon_style_inactive': 'text-shadow: 2px 2px #5f5555;color: #fff;', 'icon_style_active': 'text-shadow: 2px 2px #5f5555;color: #2093f5;'}, 'post_service_inactive': {'entity_id': 'light.bedroom_2', 'service': 'homeassistant/turn_off'}, 'icon_off': 'mdi-lightbulb', 'icons': {'icon_off': 'mdi-lightbulb', 'icon_on': 'mdi-lightbulb-on'}, 'static_icons': [], 'state_active': 'on'})
