$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-skynet"] = new basedisplay("default-skynet", "", "transparant", {'fields': {'title': '', 'title2': '', 'state_text': '', 'unit': '', 'value': 'SKYNET'}, 'precision': 1, 'widget_type': 'basedisplay', 'static_css': {'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'unit_style': '', 'widget_style': 'border-top-right-radius: 30px;border-top-left-radius: 30px;background-color: rgba(125,250,250,0.5);', 'title_style': 'color: white;text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;', 'state_text_style': 'color: #fff;', 'value_style': 'color: #000;'}, 'skin': 'glassic', 'css': {}, 'static_icons': [], 'use_comma': 0, 'use_hass_icon': 1, 'icons': []})
    
        widgets["default-clock"] = new baseclock("default-clock", "", "transparant", {'fields': {'time': '', 'date': ''}, 'precision': 1, 'widget_type': 'baseclock', 'use_comma': 0, 'static_css': {'date_style': 'color: #fff;', 'time_style': 'color: #aa00ff;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'skin': 'glassic', 'css': {}, 'static_icons': [], 'time_format': '24hr', 'use_hass_icon': 1, 'icons': []})
    
        widgets["default-temp"] = new basedisplay("default-temp", "", "transparant", {'entity': 'sensor.external_temp', 'fields': {'title': 'Температура', 'title2': '', 'state_text': '', 'unit': '', 'value': ''}, 'widget_type': 'basedisplay', 'precision': 1, 'static_icons': [], 'sub_entity': '', 'static_css': {'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'unit_style': '', 'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'state_text_style': '', 'value_style': ''}, 'use_hass_icon': 1, 'skin': 'glassic', 'css': {'unit_style': 'color: #00aaff;', 'text_style': '', 'value_style': 'color: #00aaff;text-shadow: 1px 1px 2px white, 0 0 25px blue, 0 0 5px white;font-size:300%;'}, 'use_comma': 0, 'icons': []})
    
        widgets["default-georgi"] = new baseswitch("default-georgi", "", "transparant", {'entity': 'device_tracker.georgi_coolpad', 'fields': {'title': 'Георги', 'icon_style': '', 'title2': '', 'state_text': '', 'icon': ''}, 'widget_type': 'baseswitch', 'state_text': 1, 'enable': 0, 'state_map': {'home': 'У дома', 'not_home': 'Навън'}, 'icon_on': 'fa-male', 'static_icons': [], 'precision': 1, 'post_service_active': {'dev_id': 'georgi_coolpad', 'location_name': 'home', 'service': 'device_tracker/see'}, 'icon_off': 'fa-male', 'static_css': {'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'state_text_style': 'color: #fff;', 'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'use_hass_icon': 1, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'state_active': 'home', 'state_inactive': 'not_home', 'post_service_inactive': {'dev_id': 'georgi_coolpad', 'location_name': 'not_home', 'service': 'device_tracker/see'}, 'active_map': ['home'], 'use_comma': 0, 'skin': 'glassic', 'icons': {'icon_on': 'fa-male', 'icon_off': 'fa-male'}})
    
        widgets["default-plamena"] = new baseswitch("default-plamena", "", "transparant", {'entity': 'device_tracker.plamena_elephone', 'fields': {'title': 'Пламена', 'icon_style': '', 'title2': '', 'state_text': '', 'icon': ''}, 'widget_type': 'baseswitch', 'state_text': 1, 'enable': 0, 'state_map': {'home': 'У дома', 'not_home': 'Навън'}, 'icon_on': 'fa-female', 'static_icons': [], 'precision': 1, 'post_service_active': {'dev_id': 'plamena_elephone', 'location_name': 'home', 'service': 'device_tracker/see'}, 'icon_off': 'fa-female', 'static_css': {'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'state_text_style': 'color: #fff;', 'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'use_hass_icon': 1, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'state_active': 'home', 'state_inactive': 'not_home', 'post_service_inactive': {'dev_id': 'plamena_elephone', 'location_name': 'not_home', 'service': 'device_tracker/see'}, 'active_map': ['home'], 'use_comma': 0, 'skin': 'glassic', 'icons': {'icon_on': 'fa-female', 'icon_off': 'fa-female'}})
    
        widgets["default-gergana"] = new baseswitch("default-gergana", "", "transparant", {'entity': 'device_tracker.android7099bb111999b997', 'fields': {'title': 'Гергана', 'icon_style': '', 'title2': '', 'state_text': '', 'icon': ''}, 'widget_type': 'baseswitch', 'state_text': 1, 'enable': 0, 'state_map': {'home': 'У дома', 'not_home': 'Навън'}, 'icon_on': 'fa-child', 'static_icons': [], 'precision': 1, 'post_service_active': {'dev_id': 'android7099bb111999b997', 'location_name': 'home', 'service': 'device_tracker/see'}, 'icon_off': 'fa-child', 'static_css': {'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'state_text_style': 'color: #fff;', 'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'use_hass_icon': 1, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'state_active': 'home', 'state_inactive': 'not_home', 'post_service_inactive': {'dev_id': 'android7099bb111999b997', 'location_name': 'not_home', 'service': 'device_tracker/see'}, 'active_map': ['home'], 'use_comma': 0, 'skin': 'glassic', 'icons': {'icon_on': 'fa-child', 'icon_off': 'fa-child'}})
    
        widgets["default-kitchen-1"] = new baselight("default-kitchen-1", "", "transparant", {'entity': 'light.kitchen_1', 'fields': {'title': 'Bedroom 2', 'icon_style': '', 'title2': '', 'state_text': '', 'units': '%', 'level': '', 'icon': ''}, 'widget_type': 'baselight', 'post_service_inactive': {'entity_id': 'light.kitchen_1', 'service': 'homeassistant/turn_off'}, 'state_map': {'on': 'Включено', 'off': 'Изключено'}, 'precision': 1, 'icon_on': 'mdi-lightbulb-on', 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'state_text': 1, 'post_service_active': {'entity_id': 'light.kitchen_1', 'service': 'homeassistant/turn_on'}, 'icon_off': 'mdi-lightbulb', 'static_css': {'level_style': 'color: #888;', 'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'unit_style': 'color: #888;', 'widget_style': 'background-color: rgba(0,0,0,0.4);', 'level_up_style': 'color: #888;', 'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'state_text_style': 'color: #fff;', 'level_down_style': 'color: #888;'}, 'use_hass_icon': 1, 'skin': 'glassic', 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'on_attributes': {'brightness': 100}, 'use_comma': 0, 'icons': {'icon_on': 'mdi-lightbulb-on', 'icon_off': 'mdi-lightbulb'}})
    
        widgets["default-light-bedroom-1"] = new baselight("default-light-bedroom-1", "", "transparant", {'entity': 'light.bedroom_1', 'fields': {'title': '', 'icon_style': '', 'title2': '', 'state_text': '', 'units': '%', 'level': '', 'icon': ''}, 'widget_type': 'baselight', 'post_service_inactive': {'entity_id': 'light.bedroom_1', 'service': 'homeassistant/turn_off'}, 'precision': 1, 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'post_service_active': {'entity_id': 'light.bedroom_1', 'service': 'homeassistant/turn_on'}, 'static_css': {'level_style': 'color: #888;', 'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'unit_style': 'color: #888;', 'widget_style': 'background-color: rgba(0,0,0,0.4);', 'level_up_style': 'color: #888;', 'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'state_text_style': 'color: #fff;', 'level_down_style': 'color: #888;'}, 'use_hass_icon': 1, 'skin': 'glassic', 'title_is_friendly_name': 1, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'use_comma': 0, 'icons': {'icon_on': 'fa-circle', 'icon_off': 'fa-circle-thin'}})
    
        widgets["default-reload"] = new javascript("default-reload", "", "transparant", {'fields': {'title': 'Презареди', 'icon_style': '', 'title2': '', 'icon': ''}, 'precision': 1, 'widget_type': 'javascript', 'command': 'location.reload(true)', 'skin': 'glassic', 'static_icons': [], 'use_hass_icon': 1, 'use_comma': 0, 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-refresh'}, 'static_css': {'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}})
    
        widgets["default-media"] = new javascript("default-media", "", "transparant", {'fields': {'title': 'Медия', 'icon_style': '', 'title2': '', 'icon': ''}, 'precision': 1, 'widget_type': 'javascript', 'icon_inactive': 'fa-tv', 'static_icons': [], 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'static_css': {'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'use_hass_icon': 1, 'skin': 'glassic', 'url': '/media', 'use_comma': 0, 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-tv'}})
    
        widgets["default-tank"] = new javascript("default-tank", "", "transparant", {'fields': {'title': 'Аквариум', 'icon_style': '', 'title2': '', 'icon': ''}, 'precision': 1, 'widget_type': 'javascript', 'icon_inactive': 'mdi-fish', 'static_icons': [], 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'static_css': {'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'use_hass_icon': 1, 'skin': 'glassic', 'url': '/tank', 'use_comma': 0, 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'mdi-fish'}})
    
        widgets["default-elena"] = new javascript("default-elena", "", "transparant", {'fields': {'title': 'Елена', 'icon_style': '', 'title2': '', 'icon': ''}, 'precision': 1, 'widget_type': 'javascript', 'icon_inactive': 'fa-bed', 'static_icons': [], 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'static_css': {'title_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'title2_style': 'color: #fff;text-shadow: 1px 1px 2px black, 0 0 25px green, 0 0 5px white;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'use_hass_icon': 1, 'skin': 'glassic', 'url': '/elena', 'use_comma': 0, 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-bed'}})
