$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-sony"] = new baseswitch("default-sony", "", "glassic", {'icons': {'icon_on': 'mdi-television', 'icon_off': 'mdi-television'}, 'use_comma': 0, 'static_css': {'title_style': 'text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);color: #899B9A;font-weight: bold;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'title2_style': 'text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);color: #899B9A;font-weight: bold;', 'state_text_style': 'color: white;'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'media_player.sonytv'}, 'entity': 'media_player.sonytv', 'state_text': 1, 'fields': {'title': 'Sony TV', 'state_text': '', 'title2': '', 'icon': '', 'icon_style': ''}, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'media_player.sonytv'}, 'static_icons': [], 'icon_style_inactive': 'color: rgb(255, 0, 85);', 'precision': 1, 'state_map': {'off': 'Изключен', 'on': 'Включен'}, 'icon_on': 'mdi-television', 'enable': 1, 'widget_type': 'baseswitch', 'state_active': 'on', 'css': {'icon_style_inactive': 'text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);color: rgb(255, 0, 85);font-weight: bold;line-height: 90%;', 'icon_style_active': 'color: rgb(170, 255, 0);line-height: 90%;'}, 'icon_off': 'mdi-television', 'state_inactive': 'off', 'icon_style_active': 'color: rgb(170, 255, 0);'})
