$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock"] = new baseclock("default-clock", "", "glassic", {'widget_type': 'baseclock', 'precision': 1, 'use_hass_icon': 1, 'use_comma': 0, 'static_css': {'date_style': 'color: #fff;font-weight: 700;font-size: 175%;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'time_style': 'line-height: 90%;color: #3B5957;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);'}, 'css': {}, 'icons': [], 'static_icons': [], 'time_format': '24hr', 'fields': {'date': '', 'time': ''}})
    
        widgets["default-temp"] = new basedisplay("default-temp", "", "glassic", {'widget_type': 'basedisplay', 'precision': 1, 'entity': 'sensor.dark_sky_temperature', 'use_hass_icon': 1, 'sub_entity': '', 'use_comma': 0, 'static_css': {'title_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'unit_style': '', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: #00aaff;font-size: 100%;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'value_style': ''}, 'css': {'text_style': 'color: #00aaff;font-size: 100%;', 'unit_style': 'color: #00aaff;font-size: 125%;', 'value_style': 'line-height: 90%;color: #3B5957;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);'}, 'icons': [], 'static_icons': [], 'fields': {'state_text': '', 'title2': '', 'title': 'Температура', 'value': '', 'unit': ''}})
    
        widgets["default-light-kitchen-1"] = new baselight("default-light-kitchen-1", "", "glassic", {'widget_type': 'baselight', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.kitchen_1'}, 'static_icons': {'icon_down': 'fa-minus', 'icon_up': 'fa-plus'}, 'css': {'icon_style_active': 'line-height: 90%;color: #00aaff;', 'icon_style_inactive': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'precision': 1, 'entity': 'light.kitchen_1', 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.kitchen_1'}, 'static_css': {'level_down_style': 'color: #888;', 'level_up_style': 'color: #888;', 'title_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'level_style': 'color: #888;', 'unit_style': 'color: #888;', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: #fff;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'use_comma': 0, 'title_is_friendly_name': 1, 'use_hass_icon': 1, 'icons': {'icon_on': 'fa-circle', 'icon_off': 'fa-circle-thin'}, 'fields': {'icon': '', 'title': '', 'level': '', 'units': '%', 'state_text': '', 'title2': '', 'icon_style': ''}})
    
        widgets["default-light-bedroom-1"] = new baselight("default-light-bedroom-1", "", "glassic", {'widget_type': 'baselight', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.bedroom_1'}, 'static_icons': {'icon_down': 'fa-minus', 'icon_up': 'fa-plus'}, 'css': {'icon_style_active': 'line-height: 90%;color: #00aaff;', 'icon_style_inactive': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'precision': 1, 'entity': 'light.bedroom_1', 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.bedroom_1'}, 'static_css': {'level_down_style': 'color: #888;', 'level_up_style': 'color: #888;', 'title_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'level_style': 'color: #888;', 'unit_style': 'color: #888;', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: #fff;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'use_comma': 0, 'title_is_friendly_name': 1, 'use_hass_icon': 1, 'icons': {'icon_on': 'fa-circle', 'icon_off': 'fa-circle-thin'}, 'fields': {'icon': '', 'title': '', 'level': '', 'units': '%', 'state_text': '', 'title2': '', 'icon_style': ''}})
    
        widgets["default-hall"] = new baselight("default-hall", "", "glassic", {'widget_type': 'baselight', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.bedroom_1'}, 'static_icons': {'icon_down': 'fa-minus', 'icon_up': 'fa-plus'}, 'css': {'icon_style_active': 'line-height: 90%;color: #00aaff;', 'icon_style_inactive': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'precision': 1, 'entity': 'light.bedroom_1', 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.bedroom_1'}, 'static_css': {'level_down_style': 'color: #888;', 'level_up_style': 'color: #888;', 'title_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'level_style': 'color: #888;', 'unit_style': 'color: #888;', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);', 'state_text_style': 'color: #fff;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'use_comma': 0, 'use_hass_icon': 1, 'icons': {'icon_on': 'fa-circle', 'icon_off': 'fa-circle-thin'}, 'fields': {'icon': '', 'title': 'Hall', 'level': '', 'units': '%', 'state_text': '', 'title2': 'Light', 'icon_style': ''}})
    
        widgets["default-default"] = new javascript("default-default", "", "glassic", {'widget_type': 'javascript', 'precision': 1, 'dashboard': 'main', 'static_css': {'title_style': 'color: #00aaff;font-weight: bold;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);'}, 'skin': 'default', 'static_icons': [], 'use_comma': 0, 'use_hass_icon': 1, 'css': {'icon_active_style': 'line-height: 90%;color: #00aaff;', 'icon_inactive_style': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'fields': {'icon': '', 'title2': 'Default', 'title': 'Skin Change', 'icon_style': ''}})
    
        widgets["default-glassic"] = new javascript("default-glassic", "", "glassic", {'widget_type': 'javascript', 'precision': 1, 'dashboard': 'main', 'static_css': {'title_style': 'color: #00aaff;font-weight: bold;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);'}, 'skin': 'glassic', 'static_icons': [], 'use_comma': 0, 'use_hass_icon': 1, 'css': {'icon_active_style': 'line-height: 90%;color: #00aaff;', 'icon_inactive_style': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'fields': {'icon': '', 'title2': 'Glassic', 'title': 'Skin Change', 'icon_style': ''}})
    
        widgets["default-simplyred"] = new javascript("default-simplyred", "", "glassic", {'widget_type': 'javascript', 'precision': 1, 'dashboard': 'main', 'static_css': {'title_style': 'color: #00aaff;font-weight: bold;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);'}, 'skin': 'simplyred', 'static_icons': [], 'use_comma': 0, 'use_hass_icon': 1, 'css': {'icon_active_style': 'line-height: 90%;color: #00aaff;', 'icon_inactive_style': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'fields': {'icon': '', 'title2': 'Simply Red', 'title': 'Skin Change', 'icon_style': ''}})
    
        widgets["default-obsidian"] = new javascript("default-obsidian", "", "glassic", {'widget_type': 'javascript', 'precision': 1, 'dashboard': 'main', 'static_css': {'title_style': 'color: #00aaff;font-weight: bold;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);'}, 'skin': 'obsidian', 'static_icons': [], 'use_comma': 0, 'use_hass_icon': 1, 'css': {'icon_active_style': 'line-height: 90%;color: #00aaff;', 'icon_inactive_style': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'fields': {'icon': '', 'title2': 'Obsidian', 'title': 'Skin Change', 'icon_style': ''}})
    
        widgets["default-zen"] = new javascript("default-zen", "", "glassic", {'widget_type': 'javascript', 'precision': 1, 'dashboard': 'main', 'static_css': {'title_style': 'color: #00aaff;font-weight: bold;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);'}, 'skin': 'zen', 'static_icons': [], 'use_comma': 0, 'use_hass_icon': 1, 'css': {'icon_active_style': 'line-height: 90%;color: #00aaff;', 'icon_inactive_style': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'icons': {'icon_inactive': 'fa-gear', 'icon_active': 'fa-spinner fa-spin'}, 'fields': {'icon': '', 'title2': 'Zen', 'title': 'Skin Change', 'icon_style': ''}})
    
        widgets["default-reload"] = new javascript("default-reload", "", "glassic", {'command': 'location.reload(true)', 'widget_type': 'javascript', 'precision': 1, 'static_css': {'title_style': 'color: #00aaff;font-weight: bold;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);', 'title2_style': 'color: #899B9A;font-weight: bold;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);'}, 'use_hass_icon': 1, 'use_comma': 0, 'static_icons': [], 'css': {'icon_active_style': 'line-height: 90%;color: #00aaff;', 'icon_inactive_style': 'line-height: 90%;color: #3B5957;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;'}, 'icons': {'icon_inactive': 'fa-refresh', 'icon_active': 'fa-spinner fa-spin'}, 'fields': {'icon': '', 'title2': '', 'title': 'Презареди', 'icon_style': ''}})
