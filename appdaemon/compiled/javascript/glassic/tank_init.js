$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-light"] = new baseswitch("default-light", "", "glassic", {'fields': {'title': 'Осветление', 'state_text': '', 'icon_style': '', 'icon': '', 'title2': ''}, 'state_inactive': 'off', 'post_service_active': {'entity_id': 'light.fish_tank_lights', 'service': 'homeassistant/turn_on'}, 'state_text': 1, 'enable': 1, 'precision': 1, 'entity': 'light.fish_tank_lights', 'static_css': {'title2_style': 'text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);color: #899B9A;font-weight: bold;', 'state_text_style': 'color: white;', 'title_style': 'text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);color: #899B9A;font-weight: bold;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'state_map': {'off': 'Изключено', 'on': 'Включено'}, 'widget_type': 'baseswitch', 'use_comma': 0, 'icon_on': 'mdi-lightbulb-on', 'css': {'icon_style_inactive': 'line-height: 90%;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;color: #3B5957;', 'icon_style_active': 'line-height: 90%;color: #00aaff;'}, 'post_service_inactive': {'entity_id': 'light.fish_tank_lights', 'service': 'homeassistant/turn_off'}, 'icon_off': 'mdi-lightbulb', 'icons': {'icon_off': 'mdi-lightbulb', 'icon_on': 'mdi-lightbulb-on'}, 'static_icons': [], 'state_active': 'on'})
    
        widgets["default-switch"] = new baseswitch("default-switch", "", "glassic", {'fields': {'title': 'Охлаждане', 'state_text': '', 'icon_style': '', 'icon': '', 'title2': ''}, 'state_inactive': 'off', 'post_service_active': {'entity_id': 'switch.fish_tank_fans', 'service': 'homeassistant/turn_on'}, 'state_text': 1, 'enable': 1, 'precision': 1, 'entity': 'switch.fish_tank_fans', 'static_css': {'title2_style': 'text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);color: #899B9A;font-weight: bold;', 'state_text_style': 'color: white;', 'title_style': 'text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);color: #899B9A;font-weight: bold;', 'widget_style': 'background-image: url(/css/glassic/img/carbon3.jpg);'}, 'state_map': {'off': 'Изключено', 'on': 'Включено'}, 'widget_type': 'baseswitch', 'use_comma': 0, 'icon_on': 'mdi-fan', 'css': {'icon_style_inactive': 'line-height: 90%;text-shadow: 0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7);font-weight: bold;color: #3B5957;', 'icon_style_active': 'line-height: 90%;color: #00aaff;'}, 'post_service_inactive': {'entity_id': 'switch.fish_tank_fans', 'service': 'homeassistant/turn_off'}, 'icon_off': 'mdi-fan', 'icons': {'icon_off': 'mdi-fan', 'icon_on': 'mdi-fan'}, 'static_icons': [], 'state_active': 'on'})
