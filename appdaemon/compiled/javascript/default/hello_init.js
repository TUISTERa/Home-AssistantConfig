$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-label"] = new basedisplay("default-label", "", "default", {'fields': {'title2': '', 'title': '', 'unit': '', 'state_text': '', 'value': 'Hello World'}, 'static_icons': [], 'icons': [], 'widget_type': 'basedisplay', 'static_css': {'value_style': 'color: #fff;', 'unit_style': '', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;', 'title_style': 'color: #fff;'}, 'css': {}})
