$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-skynet"] = new basedisplay("default-skynet", "", "clear_sky", {'icons': [], 'use_comma': 0, 'widget_type': 'basedisplay', 'skin': 'glassic', 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'state_text_style': 'color: #fff;', 'value_style': 'color: #fff;', 'unit_style': '', 'title2_style': 'color: #fff;font-weight: 400;'}, 'use_hass_icon': 1, 'fields': {'title': '', 'state_text': '', 'title2': '', 'unit': '', 'value': 'SKYNET'}, 'css': {}, 'static_icons': [], 'precision': 1})
    
        widgets["default-clock"] = new baseclock("default-clock", "", "clear_sky", {'icons': [], 'use_comma': 0, 'widget_type': 'baseclock', 'skin': 'glassic', 'static_css': {'time_style': 'color: #fff;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'date_style': 'color: #fff;'}, 'time_format': '24hr', 'use_hass_icon': 1, 'fields': {'date': '', 'time': ''}, 'css': {}, 'static_icons': [], 'precision': 1})
    
        widgets["default-temp"] = new basedisplay("default-temp", "", "clear_sky", {'icons': [], 'use_comma': 0, 'skin': 'glassic', 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'state_text_style': '', 'value_style': '', 'unit_style': '', 'title2_style': 'color: #fff;font-weight: 400;'}, 'entity': 'sensor.external_temp', 'use_hass_icon': 1, 'fields': {'title': 'Температура', 'state_text': '', 'title2': '', 'unit': '', 'value': ''}, 'static_icons': [], 'precision': 1, 'widget_type': 'basedisplay', 'sub_entity': '', 'css': {'value_style': 'font-size: 250%;', 'text_style': 'font-size: 100%;', 'unit_style': 'font-size: 100%;'}})
    
        widgets["default-georgi"] = new baseswitch("default-georgi", "", "clear_sky", {'icons': {'icon_on': 'fa-male', 'icon_off': 'fa-male'}, 'use_comma': 0, 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'title2_style': 'color: #fff;font-weight: 400;', 'state_text_style': 'color: #fff;font-weight: 400;'}, 'post_service_inactive': {'service': 'device_tracker/see', 'dev_id': 'georgi_coolpad', 'location_name': 'not_home'}, 'entity': 'device_tracker.georgi_coolpad', 'state_text': 1, 'fields': {'title': 'Георги', 'state_text': '', 'title2': '', 'icon': '', 'icon_style': ''}, 'state_active': 'home', 'precision': 1, 'icon_off': 'fa-male', 'static_icons': [], 'icon_on': 'fa-male', 'enable': 0, 'widget_type': 'baseswitch', 'active_map': ['home'], 'post_service_active': {'service': 'device_tracker/see', 'dev_id': 'georgi_coolpad', 'location_name': 'home'}, 'use_hass_icon': 1, 'css': {'icon_style_inactive': 'color: #888;', 'icon_style_active': 'color: #00aaff;'}, 'state_inactive': 'not_home', 'state_map': {'not_home': 'Навън', 'home': 'У дома'}, 'skin': 'glassic'})
    
        widgets["default-plamena"] = new baseswitch("default-plamena", "", "clear_sky", {'icons': {'icon_on': 'fa-female', 'icon_off': 'fa-female'}, 'use_comma': 0, 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'title2_style': 'color: #fff;font-weight: 400;', 'state_text_style': 'color: #fff;font-weight: 400;'}, 'post_service_inactive': {'service': 'device_tracker/see', 'dev_id': 'plamena_elephone', 'location_name': 'not_home'}, 'entity': 'device_tracker.plamena_elephone', 'state_text': 1, 'fields': {'title': 'Пламена', 'state_text': '', 'title2': '', 'icon': '', 'icon_style': ''}, 'state_active': 'home', 'precision': 1, 'icon_off': 'fa-female', 'static_icons': [], 'icon_on': 'fa-female', 'enable': 0, 'widget_type': 'baseswitch', 'active_map': ['home'], 'post_service_active': {'service': 'device_tracker/see', 'dev_id': 'plamena_elephone', 'location_name': 'home'}, 'use_hass_icon': 1, 'css': {'icon_style_inactive': 'color: #888;', 'icon_style_active': 'color: #00aaff;'}, 'state_inactive': 'not_home', 'state_map': {'not_home': 'Навън', 'home': 'У дома'}, 'skin': 'glassic'})
    
        widgets["default-gergana"] = new baseswitch("default-gergana", "", "clear_sky", {'icons': {'icon_on': 'fa-child', 'icon_off': 'fa-child'}, 'use_comma': 0, 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'title2_style': 'color: #fff;font-weight: 400;', 'state_text_style': 'color: #fff;font-weight: 400;'}, 'post_service_inactive': {'service': 'device_tracker/see', 'dev_id': 'android7099bb111999b997', 'location_name': 'not_home'}, 'entity': 'device_tracker.android7099bb111999b997', 'state_text': 1, 'fields': {'title': 'Гергана', 'state_text': '', 'title2': '', 'icon': '', 'icon_style': ''}, 'state_active': 'home', 'precision': 1, 'icon_off': 'fa-child', 'static_icons': [], 'icon_on': 'fa-child', 'enable': 0, 'widget_type': 'baseswitch', 'active_map': ['home'], 'post_service_active': {'service': 'device_tracker/see', 'dev_id': 'android7099bb111999b997', 'location_name': 'home'}, 'use_hass_icon': 1, 'css': {'icon_style_inactive': 'color: #888;', 'icon_style_active': 'color: #00aaff;'}, 'state_inactive': 'not_home', 'state_map': {'not_home': 'Навън', 'home': 'У дома'}, 'skin': 'glassic'})
    
        widgets["default-kitchen-1"] = new baselight("default-kitchen-1", "", "clear_sky", {'icons': {'icon_on': 'mdi-lightbulb-on', 'icon_off': 'mdi-lightbulb'}, 'use_comma': 0, 'static_css': {'level_style': 'color: #888;', 'title_style': 'color: #fff;font-weight: 400;', 'level_down_style': 'color: #888;', 'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'level_up_style': 'color: #888;', 'unit_style': 'color: #888;', 'state_text_style': 'color: #fff;'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.kitchen_1'}, 'entity': 'light.kitchen_1', 'use_hass_icon': 1, 'fields': {'title2': '', 'icon': '', 'units': '%', 'title': 'Bedroom 2', 'state_text': '', 'level': '', 'icon_style': ''}, 'on_attributes': {'brightness': 100}, 'precision': 1, 'icon_off': 'mdi-lightbulb', 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'icon_on': 'mdi-lightbulb-on', 'state_map': {'off': 'Изключено', 'on': 'Включено'}, 'widget_type': 'baselight', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.kitchen_1'}, 'css': {'icon_style_inactive': 'color: antiquewhite;', 'icon_style_active': 'color: #ffff00;'}, 'state_text': 1, 'skin': 'glassic'})
    
        widgets["default-light-bedroom-1"] = new baselight("default-light-bedroom-1", "", "clear_sky", {'icons': {'icon_on': 'fa-lightbulb-o', 'icon_off': 'fa-lightbulb-o'}, 'use_comma': 0, 'static_css': {'level_style': 'color: #888;', 'title_style': 'color: #fff;font-weight: 400;', 'level_down_style': 'color: #888;', 'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'level_up_style': 'color: #888;', 'unit_style': 'color: #888;', 'state_text_style': 'color: #fff;'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.bedroom_1'}, 'entity': 'light.bedroom_1', 'use_hass_icon': 1, 'fields': {'title2': '', 'icon': '', 'units': '%', 'title': '', 'state_text': '', 'level': '', 'icon_style': ''}, 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'precision': 1, 'widget_type': 'baselight', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.bedroom_1'}, 'title_is_friendly_name': 1, 'css': {'icon_style_inactive': 'color: antiquewhite;', 'icon_style_active': 'color: #ffff00;'}, 'skin': 'glassic'})
    
        widgets["default-reload"] = new javascript("default-reload", "", "clear_sky", {'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-refresh'}, 'command': 'location.reload(true)', 'widget_type': 'javascript', 'skin': 'glassic', 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'title2_style': 'color: #fff;font-weight: 400;'}, 'use_comma': 0, 'use_hass_icon': 1, 'fields': {'title': 'Презареди', 'title2': '', 'icon': '', 'icon_style': ''}, 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}, 'static_icons': [], 'precision': 1})
    
        widgets["default-media"] = new javascript("default-media", "", "clear_sky", {'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-tv'}, 'use_comma': 0, 'url': '/media', 'skin': 'glassic', 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'title2_style': 'color: #fff;font-weight: 400;'}, 'use_hass_icon': 1, 'fields': {'title': 'Медия', 'title2': '', 'icon': '', 'icon_style': ''}, 'static_icons': [], 'precision': 1, 'widget_type': 'javascript', 'icon_inactive': 'fa-tv', 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
    
        widgets["default-tank"] = new javascript("default-tank", "", "clear_sky", {'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'mdi-fish'}, 'use_comma': 0, 'url': '/tank', 'skin': 'glassic', 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'title2_style': 'color: #fff;font-weight: 400;'}, 'use_hass_icon': 1, 'fields': {'title': 'Аквариум', 'title2': '', 'icon': '', 'icon_style': ''}, 'static_icons': [], 'precision': 1, 'widget_type': 'javascript', 'icon_inactive': 'mdi-fish', 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
    
        widgets["default-elena"] = new javascript("default-elena", "", "clear_sky", {'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-bed'}, 'use_comma': 0, 'url': '/elena', 'skin': 'glassic', 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'title2_style': 'color: #fff;font-weight: 400;'}, 'use_hass_icon': 1, 'fields': {'title': 'Елена', 'title2': '', 'icon': '', 'icon_style': ''}, 'static_icons': [], 'precision': 1, 'widget_type': 'javascript', 'icon_inactive': 'fa-bed', 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}})
