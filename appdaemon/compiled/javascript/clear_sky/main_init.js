$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-skynet"] = new basedisplay("default-skynet", "", "clear_sky", {'use_hass_icon': 1, 'use_comma': 0, 'skin': 'glassic', 'fields': {'title': '', 'value': 'SKYNET', 'state_text': '', 'unit': '', 'title2': ''}, 'css': {}, 'widget_type': 'basedisplay', 'icons': [], 'static_icons': [], 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'state_text_style': 'color: #fff;', 'value_style': 'color: #fff;', 'unit_style': '', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'title_style': 'font-weight: 400;color: #fff;'}, 'precision': 1})
    
        widgets["default-clock"] = new baseclock("default-clock", "", "clear_sky", {'use_hass_icon': 1, 'use_comma': 0, 'skin': 'glassic', 'fields': {'date': '', 'time': ''}, 'css': {}, 'widget_type': 'baseclock', 'icons': [], 'static_icons': [], 'static_css': {'date_style': 'color: #fff;', 'time_style': 'color: #fff;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;'}, 'time_format': '24hr', 'precision': 1})
    
        widgets["default-temp"] = new basedisplay("default-temp", "", "clear_sky", {'fields': {'title': 'Температура', 'value': '', 'state_text': '', 'unit': '', 'title2': ''}, 'use_hass_icon': 1, 'sub_entity': '', 'precision': 1, 'entity': 'sensor.external_temp', 'widget_type': 'basedisplay', 'use_comma': 0, 'css': {'value_style': 'font-size: 250%;', 'unit_style': 'font-size: 100%;', 'text_style': 'font-size: 100%;'}, 'skin': 'glassic', 'icons': [], 'static_icons': [], 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'state_text_style': '', 'value_style': '', 'unit_style': '', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'title_style': 'font-weight: 400;color: #fff;'}})
    
        widgets["default-georgi"] = new baseswitch("default-georgi", "", "clear_sky", {'fields': {'title': 'Георги', 'state_text': '', 'icon_style': '', 'icon': '', 'title2': ''}, 'enable': 0, 'state_inactive': 'not_home', 'widget_type': 'baseswitch', 'state_text': 1, 'post_service_active': {'service': 'device_tracker/see', 'dev_id': 'georgi_coolpad', 'location_name': 'home'}, 'precision': 1, 'entity': 'device_tracker.georgi_coolpad', 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'state_text_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;'}, 'state_map': {'not_home': 'Навън', 'home': 'У дома'}, 'use_hass_icon': 1, 'use_comma': 0, 'icon_on': 'fa-male', 'active_map': ['home'], 'post_service_inactive': {'service': 'device_tracker/see', 'dev_id': 'georgi_coolpad', 'location_name': 'not_home'}, 'css': {'icon_style_inactive': 'color: #888;', 'icon_style_active': 'color: #00aaff;'}, 'skin': 'glassic', 'icon_off': 'fa-male', 'icons': {'icon_off': 'fa-male', 'icon_on': 'fa-male'}, 'static_icons': [], 'state_active': 'home'})
    
        widgets["default-plamena"] = new baseswitch("default-plamena", "", "clear_sky", {'fields': {'title': 'Пламена', 'state_text': '', 'icon_style': '', 'icon': '', 'title2': ''}, 'enable': 0, 'state_inactive': 'not_home', 'widget_type': 'baseswitch', 'state_text': 1, 'post_service_active': {'service': 'device_tracker/see', 'dev_id': 'plamena_elephone', 'location_name': 'home'}, 'precision': 1, 'entity': 'device_tracker.plamena_elephone', 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'state_text_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;'}, 'state_map': {'not_home': 'Навън', 'home': 'У дома'}, 'use_hass_icon': 1, 'use_comma': 0, 'icon_on': 'fa-female', 'active_map': ['home'], 'post_service_inactive': {'service': 'device_tracker/see', 'dev_id': 'plamena_elephone', 'location_name': 'not_home'}, 'css': {'icon_style_inactive': 'color: #888;', 'icon_style_active': 'color: #00aaff;'}, 'skin': 'glassic', 'icon_off': 'fa-female', 'icons': {'icon_off': 'fa-female', 'icon_on': 'fa-female'}, 'static_icons': [], 'state_active': 'home'})
    
        widgets["default-gergana"] = new baseswitch("default-gergana", "", "clear_sky", {'fields': {'title': 'Гергана', 'state_text': '', 'icon_style': '', 'icon': '', 'title2': ''}, 'enable': 0, 'state_inactive': 'not_home', 'widget_type': 'baseswitch', 'state_text': 1, 'post_service_active': {'service': 'device_tracker/see', 'dev_id': 'android7099bb111999b997', 'location_name': 'home'}, 'precision': 1, 'entity': 'device_tracker.android7099bb111999b997', 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'state_text_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;'}, 'state_map': {'not_home': 'Навън', 'home': 'У дома'}, 'use_hass_icon': 1, 'use_comma': 0, 'icon_on': 'fa-child', 'active_map': ['home'], 'post_service_inactive': {'service': 'device_tracker/see', 'dev_id': 'android7099bb111999b997', 'location_name': 'not_home'}, 'css': {'icon_style_inactive': 'color: #888;', 'icon_style_active': 'color: #00aaff;'}, 'skin': 'glassic', 'icon_off': 'fa-child', 'icons': {'icon_off': 'fa-child', 'icon_on': 'fa-child'}, 'static_icons': [], 'state_active': 'home'})
    
        widgets["default-kitchen-1"] = new baselight("default-kitchen-1", "", "clear_sky", {'fields': {'title': 'Bedroom 2', 'units': '%', 'icon': '', 'state_text': '', 'icon_style': '', 'level': '', 'title2': ''}, 'widget_type': 'baselight', 'state_text': 1, 'static_icons': {'icon_down': 'fa-minus', 'icon_up': 'fa-plus'}, 'post_service_active': {'entity_id': 'light.kitchen_1', 'service': 'homeassistant/turn_on'}, 'precision': 1, 'entity': 'light.kitchen_1', 'state_map': {'off': 'Изключено', 'on': 'Включено'}, 'use_hass_icon': 1, 'use_comma': 0, 'icon_on': 'mdi-lightbulb-on', 'post_service_inactive': {'entity_id': 'light.kitchen_1', 'service': 'homeassistant/turn_off'}, 'css': {'icon_style_inactive': 'color: antiquewhite;', 'icon_style_active': 'color: #ffff00;'}, 'skin': 'glassic', 'icon_off': 'mdi-lightbulb', 'icons': {'icon_off': 'mdi-lightbulb', 'icon_on': 'mdi-lightbulb-on'}, 'on_attributes': {'brightness': 100}, 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'state_text_style': 'color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'unit_style': 'color: #888;', 'level_style': 'color: #888;', 'level_up_style': 'color: #888;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'level_down_style': 'color: #888;'}})
    
        widgets["default-light-bedroom-1"] = new baselight("default-light-bedroom-1", "", "clear_sky", {'fields': {'title': '', 'units': '%', 'icon': '', 'state_text': '', 'icon_style': '', 'level': '', 'title2': ''}, 'widget_type': 'baselight', 'post_service_active': {'entity_id': 'light.bedroom_1', 'service': 'homeassistant/turn_on'}, 'precision': 1, 'title_is_friendly_name': 1, 'use_hass_icon': 1, 'use_comma': 0, 'entity': 'light.bedroom_1', 'post_service_inactive': {'entity_id': 'light.bedroom_1', 'service': 'homeassistant/turn_off'}, 'css': {'icon_style_inactive': 'color: antiquewhite;', 'icon_style_active': 'color: #ffff00;'}, 'skin': 'glassic', 'icons': {'icon_off': 'fa-lightbulb-o', 'icon_on': 'fa-lightbulb-o'}, 'static_icons': {'icon_down': 'fa-minus', 'icon_up': 'fa-plus'}, 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'state_text_style': 'color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'unit_style': 'color: #888;', 'level_style': 'color: #888;', 'level_up_style': 'color: #888;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;', 'level_down_style': 'color: #888;'}})
    
        widgets["default-reload"] = new javascript("default-reload", "", "clear_sky", {'command': 'location.reload(true)', 'widget_type': 'javascript', 'use_comma': 0, 'fields': {'title': 'Презареди', 'icon_style': '', 'icon': '', 'title2': ''}, 'use_hass_icon': 1, 'skin': 'glassic', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-refresh'}, 'static_icons': [], 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;'}, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'precision': 1})
    
        widgets["default-media"] = new javascript("default-media", "", "clear_sky", {'fields': {'title': 'Медия', 'icon_style': '', 'icon': '', 'title2': ''}, 'widget_type': 'javascript', 'url': '/media', 'precision': 1, 'icon_inactive': 'fa-tv', 'use_hass_icon': 1, 'use_comma': 0, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'skin': 'clear_sky', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-tv'}, 'static_icons': [], 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;'}})
    
        widgets["default-tank"] = new javascript("default-tank", "", "clear_sky", {'fields': {'title': 'Аквариум', 'icon_style': '', 'icon': '', 'title2': ''}, 'widget_type': 'javascript', 'url': '/tank', 'precision': 1, 'icon_inactive': 'mdi-fish', 'use_hass_icon': 1, 'use_comma': 0, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'skin': 'clear_sky', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'mdi-fish'}, 'static_icons': [], 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;'}})
    
        widgets["default-elena"] = new javascript("default-elena", "", "clear_sky", {'fields': {'title': 'Елена', 'icon_style': '', 'icon': '', 'title2': ''}, 'widget_type': 'javascript', 'url': '/elena', 'precision': 1, 'icon_inactive': 'fa-bed', 'use_hass_icon': 1, 'use_comma': 0, 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #fff;'}, 'skin': 'clear_sky', 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-bed'}, 'static_icons': [], 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'widget_style': 'background-color: rgba(68,68,68,0.7);color: #00aaff;'}})
