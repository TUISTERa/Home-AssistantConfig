$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock"] = new baseclock("default-clock", "", "dark_flower", {'widget_type': 'baseclock', 'use_comma': 0, 'fields': {'date': '', 'time': ''}, 'css': {}, 'icons': [], 'static_icons': [], 'static_css': {'date_style': 'color: #fff;', 'time_style': 'color: #fff;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'time_format': '24hr', 'precision': 1})
    
        widgets["default-temp"] = new basedisplay("default-temp", "", "dark_flower", {'css': {'value_style': '', 'unit_style': '', 'text_style': 'color: #fff;'}, 'fields': {'title': 'Температура', 'value': '', 'state_text': '', 'unit': '', 'title2': ''}, 'use_comma': 0, 'widget_type': 'basedisplay', 'sub_entity': '', 'icons': [], 'static_icons': [], 'precision': 1, 'entity': 'sensor.tank_temp', 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'state_text_style': '', 'value_style': '', 'unit_style': '', 'widget_style': 'background-color: rgba(0,0,0,0.4);', 'title_style': 'font-weight: 400;color: #fff;'}})
    
        widgets["default-light"] = new baseswitch("default-light", "", "dark_flower", {'fields': {'title': 'Осветление', 'state_text': '', 'icon_style': '', 'icon': '', 'title2': ''}, 'state_inactive': 'off', 'post_service_active': {'entity_id': 'light.bedroom_2', 'service': 'homeassistant/turn_on'}, 'enable': 1, 'precision': 1, 'icon_on': 'mdi-lightbulb-on', 'static_css': {'title2_style': 'font-weight: 400;color: #fff;', 'state_text_style': 'color: #fff;', 'title_style': 'font-weight: 400;color: #fff;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'widget_type': 'baseswitch', 'use_comma': 0, 'entity': 'light.bedroom_2', 'css': {'icon_style_inactive': 'color: antiquewhite;', 'icon_style_active': 'color: #ffaa00;'}, 'post_service_inactive': {'entity_id': 'light.bedroom_2', 'service': 'homeassistant/turn_off'}, 'icon_off': 'mdi-lightbulb', 'icons': {'icon_off': 'mdi-lightbulb', 'icon_on': 'mdi-lightbulb-on'}, 'static_icons': [], 'state_active': 'on'})
